    ...
    <header className="fixed top-0 left-0 lg:left-72 right-0 h-16 glass z-30 flex items-center justify-between px-4 lg:px-6 transition-all duration-300 border-b border-outline-variant/50">
      ...
      <div className="flex items-center gap-2 lg:gap-3.5">
        ...
        <div className="flex items-center gap-2.5 px-3.5 py-1.5 rounded-xl bg-surface-container/60 border border-outline-variant/30">
          ...
          <span className="font-mono text-sm sm:text-base uppercase tracking-wider text-on-surface-variant truncate max-w-[200px] sm:max-w-none font-bold">
            {subtitle}
          </span>
        </div>
        ...
        <button
          ...
          className={`
            hidden md:flex items-center gap-2 px-3.5 py-1.5 rounded-full border text-xs sm:text-sm font-mono font-bold transition-all duration-200 shadow-xs
            ${isSimulating
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        {/* Real-time Clock */}
        <div className="hidden sm:flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-surface-container-lowest/80 border border-outline-variant/40 font-mono text-sm font-bold text-on-surface shadow-xs">
          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl bg-surface-container-lowest/98 backdrop-blur-2xl border border-outline-variant/80 shadow-2xl shadow-black/10 py-3 animate-scale-in z-50">
              ...
              <div className="pt-2.5 px-3 text-center border-t border-outline-variant/40">
                <button className="w-full py-2 text-xs sm:text-sm font-bold text-primary hover:bg-surface-container rounded-xl transition-colors">
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-68 rounded-2xl bg-surface-container-lowest/98 backdrop-blur-2xl border border-outline-variant/80 shadow-2xl shadow-black/10 p-2.5 animate-scale-in z-50">
              ...
              <div className="space-y-1">
                <button className="w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold text-on-surface hover:bg-surface-container hover:text-primary rounded-xl transition-colors">
              ...
              <div className="border-t border-outline-variant/40 mt-1.5 pt-1.5">
                <button className="w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-bold text-error hover:bg-error/10 rounded-xl transition-colors">
