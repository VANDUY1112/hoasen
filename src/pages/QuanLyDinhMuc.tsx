      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs sm:text-sm text-primary uppercase font-bold tracking-wider">Performance Benchmarking</span>
        ...
        {[
          ...
          >
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="p-2.5 rounded-xl bg-surface-container text-on-surface-variant group-hover:text-primary group-hover:bg-primary/10 transition-colors">
                <item.icon size={20} />
              </div>
            </div>
            <div className="flex items-baseline gap-2.5">
              <span className="text-3xl sm:text-4xl font-extrabold text-on-surface font-mono">{item.value}</span>
              <span className="font-mono text-sm text-on-surface-variant font-bold">{item.unit}</span>
            </div>
            {item.trend && (
              <div className="mt-3.5 flex items-center gap-2">
                <span className="flex items-center text-xs sm:text-sm font-bold text-emerald-600 bg-emerald-500/10 px-2.5 py-0.5 rounded-md font-mono">
                  <TrendingUp size={15} className="mr-1" /> {item.trend}
                </span>
                <span className="text-xs text-on-surface-variant italic font-medium">vs tháng trước</span>
              </div>
            )}
